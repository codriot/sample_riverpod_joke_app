...
abstract class $JokeModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    String setup,
    String punchline,
    @JsonKey(name: 'type') String category,
  });
}
...
class _$JokeModelImpl extends _JokeModel {
  const _$JokeModelImpl({
    ...
    @JsonKey(name: 'type') required this.category,
  }) : super._();
  ...
  @override
  String toString() {
    return 'JokeModel(id: $id, setup: $setup, punchline: $punchline, category: $category)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, setup, punchline, category);
...
abstract class _JokeModel extends JokeModel {
  const factory _JokeModel({
    ...
    @JsonKey(name: 'type') required final String category,
  }) = _$JokeModelImpl;
